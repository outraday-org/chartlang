...
//
// Ported from apps/site/src/lib/server/compile.ts.
//
...
const SOURCE_PATH = "starter.chart.ts"
...
// compile failure (no diagnostics), not a 500. The cap lives in
// `./constants` so the save path enforces the exact same limit.
