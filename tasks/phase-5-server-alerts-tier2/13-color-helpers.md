...
- [ ] Four helpers + `GradientStop` type exported from core.
- [ ] Property tests pin idempotence, range clamping, round-trip.
- [ ] NaN fallbacks behave per JSDoc.
- [ ] 100% coverage on color helpers + parser.
- [ ] `pnpm docs:check` green; auto-generated docs pages exist.
- [ ] Changeset committed.
