...
- [x] All 10 sandbox-escape tests pass; each pins a documented
      blocking mechanism.
- [x] `perBarCompute` bench under the documented threshold.
- [x] CLAUDE.md lists every vector covered.
- [x] README's stability claim is accurate.
- [x] 100% coverage maintained; gates green.
