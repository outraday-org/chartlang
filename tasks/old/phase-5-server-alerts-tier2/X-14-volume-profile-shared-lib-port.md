...
- [x] Every file ships the 4-line provenance header.
- [x] Each helper retains its invinite test, retargeted; new
      property tests pin the listed invariants.
- [x] `bucketizeVolume` bench under threshold.
- [x] No public re-export from the package barrel — helpers are
      package-private.
