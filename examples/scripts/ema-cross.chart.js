...
// packages/compiler/examples/scripts/ema-cross.chart.ts
var ema_cross_chart_default = defineIndicator({
  name: "EMA Cross",
  apiVersion: 1,
  overlay: true,
  compute({ bar, ta: ta3, plot: plot3, alert: alert3 }) {
    const fast = ta3.ema("examples/scripts/ema-cross.chart.ts:11:22#0", bar.close, 12);
    const slow = ta3.ema("examples/scripts/ema-cross.chart.ts:12:22#0", bar.close, 26);
    plot3("examples/scripts/ema-cross.chart.ts:14:9#0", fast, { color: "#26a69a", title: "EMA(12)" });
    plot3("examples/scripts/ema-cross.chart.ts:15:9#0", slow, { color: "#ef5350", title: "EMA(26)" });
    if (ta3.crossover("examples/scripts/ema-cross.chart.ts:17:13#0", fast, slow).current) {
      alert3("examples/scripts/ema-cross.chart.ts:18:13#0", "EMA(12) crossed above EMA(26)", { severity: "info" });
    }
    if (ta3.crossunder("examples/scripts/ema-cross.chart.ts:20:13#0", fast, slow).current) {
      alert3("examples/scripts/ema-cross.chart.ts:21:13#0", "EMA(12) crossed below EMA(26)", { severity: "warning" });
    }
  },
  outputs: [{ title: "EMA(12)", kind: "series-number" }, { title: "EMA(26)", kind: "series-number" }]
});
export {
  ema_cross_chart_default as default
};
export const __manifest = {"apiVersion":1,"kind":"indicator","name":"EMA Cross","inputs":{},"capabilities":["alerts","indicators"],"requestedIntervals":[],"userPickableInterval":false,"seriesCapacities":{},"maxLookback":0,"overlay":true,"outputs":[{"title":"EMA(12)","kind":"series-number"},{"title":"EMA(26)","kind":"series-number"}],"plots":[{"slotId":"examples/scripts/ema-cross.chart.ts:14:9#0","kind":"line","title":"EMA(12)"},{"slotId":"examples/scripts/ema-cross.chart.ts:15:9#0","kind":"line","title":"EMA(26)"}]};
ema_cross_chart_default = Object.freeze({ ...ema_cross_chart_default, manifest: {"apiVersion":1,"kind":"indicator","name":"EMA Cross","inputs":{},"capabilities":["alerts","indicators"],"requestedIntervals":[],"userPickableInterval":false,"seriesCapacities":{},"maxLookback":0,"overlay":true,"outputs":[{"title":"EMA(12)","kind":"series-number"},{"title":"EMA(26)","kind":"series-number"}],"plots":[{"slotId":"examples/scripts/ema-cross.chart.ts:14:9#0","kind":"line","title":"EMA(12)"},{"slotId":"examples/scripts/ema-cross.chart.ts:15:9#0","kind":"line","title":"EMA(26)"}]} });
