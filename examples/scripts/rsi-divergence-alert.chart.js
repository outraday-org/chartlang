...
// packages/compiler/examples/scripts/rsi-divergence-alert.chart.ts
var rsi_divergence_alert_chart_default = defineIndicator({
  name: "RSI Divergence Alert",
  apiVersion: 1,
  overlay: false,
  compute({ bar, ta: ta3, plot: plot3, hline: hline3, alert: alert3 }) {
    const rsi = ta3.rsi("examples/scripts/rsi-divergence-alert.chart.ts:11:21#0", bar.close, 14);
    plot3("examples/scripts/rsi-divergence-alert.chart.ts:12:9#0", rsi, { color: "#9c27b0", title: "RSI(14)" });
    hline3("examples/scripts/rsi-divergence-alert.chart.ts:14:9#0", 70, { color: "#ef5350", lineStyle: "dashed", title: "Overbought" });
    hline3("examples/scripts/rsi-divergence-alert.chart.ts:15:9#0", 30, { color: "#26a69a", lineStyle: "dashed", title: "Oversold" });
    if (ta3.crossunder("examples/scripts/rsi-divergence-alert.chart.ts:17:13#0", rsi, 70).current) {
      alert3("examples/scripts/rsi-divergence-alert.chart.ts:18:13#0", "RSI dropped below 70 (overbought exit)", { severity: "warning" });
    }
