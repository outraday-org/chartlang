...
// packages/compiler/examples/scripts/mintick-snapped-entry.chart.ts
var mintick_snapped_entry_chart_default = defineIndicator({
  ...
  compute({ bar, syminfo: syminfo3, plot: plot3, inputs }) {
    const target = bar.close * (1 + inputs.offsetPercent / 100);
    if (!Number.isFinite(syminfo3.mintick)) {
      plot3("examples/scripts/mintick-snapped-entry.chart.ts:20:13#0", target, { color: "#10b981", title: "Target (raw)" });
      return;
    }
    const snapped = Math.round(target / syminfo3.mintick) * syminfo3.mintick;
    plot3("examples/scripts/mintick-snapped-entry.chart.ts:24:9#0", snapped, { color: "#10b981", title: "Target (snapped)" });
  },
  outputs: [{ title: "Target (raw)", kind: "series-number" }, { title: "Target (snapped)", kind: "series-number" }]
});
export {
  mintick_snapped_entry_chart_default as default
};
export const __manifest = {"apiVersion":1,"kind":"indicator","name":"Mintick Snapped Entry","inputs":{"offsetPercent":{"kind":"float","defaultValue":2,"min":0,"max":50,"step":0.1,"title":"Offset (%)"}},"capabilities":["indicators"],"requestedIntervals":[],"userPickableInterval":false,"seriesCapacities":{},"maxLookback":0,"overlay":true,"outputs":[{"title":"Target (raw)","kind":"series-number"},{"title":"Target (snapped)","kind":"series-number"}],"plots":[{"slotId":"examples/scripts/mintick-snapped-entry.chart.ts:20:13#0","kind":"line","title":"Target (raw)"},{"slotId":"examples/scripts/mintick-snapped-entry.chart.ts:24:9#0","kind":"line","title":"Target (snapped)"}]};
mintick_snapped_entry_chart_default = Object.freeze({ ...mintick_snapped_entry_chart_default, manifest: {"apiVersion":1,"kind":"indicator","name":"Mintick Snapped Entry","inputs":{"offsetPercent":{"kind":"float","defaultValue":2,"min":0,"max":50,"step":0.1,"title":"Offset (%)"}},"capabilities":["indicators"],"requestedIntervals":[],"userPickableInterval":false,"seriesCapacities":{},"maxLookback":0,"overlay":true,"outputs":[{"title":"Target (raw)","kind":"series-number"},{"title":"Target (snapped)","kind":"series-number"}],"plots":[{"slotId":"examples/scripts/mintick-snapped-entry.chart.ts:20:13#0","kind":"line","title":"Target (raw)"},{"slotId":"examples/scripts/mintick-snapped-entry.chart.ts:24:9#0","kind":"line","title":"Target (snapped)"}]} });
