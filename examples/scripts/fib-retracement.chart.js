...
export const __manifest = {"apiVersion":1,"kind":"indicator","name":"Fib Retracement","inputs":{},"capabilities":["indicators"],"requestedIntervals":[],"userPickableInterval":false,"seriesCapacities":{},"maxLookback":0,"overlay":true};
fib_retracement_chart_default = Object.freeze({ ...fib_retracement_chart_default, manifest: {"apiVersion":1,"kind":"indicator","name":"Fib Retracement","inputs":{},"capabilities":["indicators"],"requestedIntervals":[],"userPickableInterval":false,"seriesCapacities":{},"maxLookback":0,"overlay":true} });
