...
- 3932418: New `orders` example category — three runnable strategy scripts
...
- 166222f: Drop the 20 redundant `inputs.<key> as T` casts from the 19 example scripts that
