...
/**
 * Stable header line emitted as the first byte sequence of every page
 * the generator writes. The `docs:gate` script compares pages by byte
 * equality, so this constant is exported so the gate (and unit tests)
