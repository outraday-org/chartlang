...
import type { AnchorQuint, ElliottTriangleWaveState } from "@invinite-org/chartlang-core";
...
import { elliottTriangleWave } from "./elliottTriangleWave.js";
...
describe("draw.elliottTriangleWave — script-facing throw", () => {
    ...
    it("throws when slotId is provided but anchors are missing", () => {
        ...
        expect(() => elliottTriangleWave("slot", undefined as unknown as AnchorQuint)).toThrow(
            "draw.elliottTriangleWave called outside an active script step",
        );
    });
