...
export { createDrawingHandle } from "./handle.js";
export { pushDrawing } from "./pushDrawing.js";
export { nextSubId, resetSubIdCounters } from "./subIdAllocator.js";
...
export { DRAW_NAMESPACE as draw } from "./namespace.js";
