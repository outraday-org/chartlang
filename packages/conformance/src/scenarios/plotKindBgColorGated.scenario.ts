...
/**
 * Phase 5 conformance scenario for plot kind bg color gated scenario.
 *
 * @since 0.5
 * @experimental
 * @example
 *     import { PLOT_KIND_BG_COLOR_GATED_SCENARIO } from "@invinite-org/chartlang-conformance";
 *     void PLOT_KIND_BG_COLOR_GATED_SCENARIO;
 */
export const PLOT_KIND_BG_COLOR_GATED_SCENARIO: Scenario = Object.freeze({
    id: "plot-kind-bg-color-gated",
    title: "PlotKind bg color gated",
