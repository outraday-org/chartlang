...
describe("TA_ANCHORED_VOLUME_PROFILE_SCENARIO", () => {
    it("passes against a time-input + horizontal-histogram capable adapter", async () => {
        const report = await runConformanceSuite(adapter(), {
            scenarios: [TA_ANCHORED_VOLUME_PROFILE_SCENARIO],
        });
