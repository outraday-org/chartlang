...
- 8fb0338: Enforce `Capabilities.inputs` at runtime with a new `unsupported-input-kind` diagnostic
...
- Updated dependencies [8fb0338]
  ...
  - @invinite-org/chartlang-runtime@1.12.0
...
- 3932418: Carry and validate the `orders` channel across the QuickJS membrane
...
- Updated dependencies [3932418]
  ...
  - @invinite-org/chartlang-runtime@1.11.0

## 1.6.0

### Minor Changes

- 160cfe6: Enforce a budget on `load()`, drain the guest job queue, and fail closed after an aborted step.
...
- 472ec9a: Poison the host only when the interrupt actually fired, not whenever a step ran long.
...
- Updated dependencies [795f544]
  ...
  - @invinite-org/chartlang-runtime@1.9.1

## 1.4.3

### Patch Changes

- 89cac8e: feat: author-selectable `area` plot style
...
- Updated dependencies [89cac8e]
  ...
  - @invinite-org/chartlang-runtime@1.9.0
...
- Updated dependencies [df3f5b2]
  - @invinite-org/chartlang-runtime@1.8.1
...
- 5266c46: Rebundle both hosts against the re-seed runtime so an overlapping `history`
...
- Updated dependencies [fb6f60a]
  ...
  - @invinite-org/chartlang-runtime@1.7.0
